...
{% assign pages = site.pages | where_exp: "page", "page.url contains '/garden/'"
   | where_exp: "page", "page.dir == '/garden/' or page.name == 'index.md'"
   | where_exp: "page", "page.title != 'Garden'" %}
{% for page in pages %}
- <p class="note-link"><a href="{{page.url}}">{{page.title}}</a> (Last Updated: {{page.updated | date_to_string}})</p>
{% endfor %}
